...
function MyProducts() {
  ...
  if (!user?.isVerified) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center px-4 bg-white rounded-3xl border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
